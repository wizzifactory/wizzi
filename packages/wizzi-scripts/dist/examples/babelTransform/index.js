/*
    ...
    primary source IttfDocument: C:\My\wizzi\wizzi-mono\packages\wizzi-scripts\.wizzi\ittf\examples\babelTransform\index.js.ittf
*/
'use strict';
...
function babel(callback) {
    manager.babelTransformExec(options1, callback);
}
function babelTransformToEventStream(callback) {
    var res = new MockResponse();
    manager.babelTransformExec(options1, res, function(err, result) {
        if (err) {
            console.log('err', err);
            throw new Error(err.message);
        }
