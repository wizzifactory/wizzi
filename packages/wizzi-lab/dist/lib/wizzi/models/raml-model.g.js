...
var ramlItem = (function (ramlBase) {
    ...
    ramlItem.prototype.toJsonChildren = function(result) {
        ...
        var items, item;
        items = [];
        var i, i_items=this.annotations, i_len=this.annotations.length, item;
        for (i=0; i<i_len; i++) {
...
var raml = (function (ramlItem) {
    ...
    raml.PROTOCOLS_NONE = "none";raml.PROTOCOLS_HTTP = "http";raml.PROTOCOLS_HTTPS = "https";raml.PROTOCOLS_HTTP_HTTPS = "http,https";raml.prototype.addBaseUriParameter = function(name, sourceLineInfo) {
    ...
    raml.prototype.toJsonChildren = function(result) {
        ...
        var items, item;
        items = [];
        var i, i_items=this.baseUriParameters, i_len=this.baseUriParameters.length, item;
        for (i=0; i<i_len; i++) {
    ...
    raml.prototype.getMediaTypes = function() {
        ...
        if (_.isObject(this.mediaTypes)) {
            var i, i_items=this.mediaTypes.mediaTypes, i_len=this.mediaTypes.mediaTypes.length, item;
            for (i=0; i<i_len; i++) {
    ...
    raml.prototype.getResources = function() {
        ...
        var i, i_items=this.resources, i_len=this.resources.length, r;
        for (i=0; i<i_len; i++) {
            r = this.resources[i];
            r.getData(resCtx);
        }
...
var namedParameter = (function (ramlItem) {
    ...
    namedParameter.TYPE_STRING = "string";namedParameter.TYPE_NUMBER = "number";namedParameter.TYPE_INTEGER = "integer";namedParameter.TYPE_DATE = "date";namedParameter.TYPE_XBOOLEAN = "boolean";namedParameter.TYPE_FILE = "file";namedParameter.ARRAYFORMAT_CSV = "csv";namedParameter.ARRAYFORMAT_MULTI = "multi";namedParameter.ARRAYFORMAT_PIPES = "pipes";namedParameter.ARRAYFORMAT_SSV = "ssv";namedParameter.ARRAYFORMAT_TSV = "tsv";namedParameter.prototype.toJson = function() {
        var result = {};
        this.toJsonProperties(result);
        this.toJsonChildren(result);
        return result;
...
var resource = (function (ramlItem) {
    ...
    resource.prototype.toJsonChildren = function(result) {
        ...
        var items, item;
        items = [];
        var i, i_items=this.uriParameters, i_len=this.uriParameters.length, item;
        for (i=0; i<i_len; i++) {
...
var method = (function (ramlItem) {
    ...
    method.PROTOCOLS_NONE = "none";method.PROTOCOLS_HTTP = "http";method.PROTOCOLS_HTTPS = "https";method.PROTOCOLS_HTTP_HTTPS = "http,https";method.prototype.addQueryParameter = function(name, sourceLineInfo) {
    ...
    method.prototype.toJsonChildren = function(result) {
        ...
        var items, item;
        items = [];
        var i, i_items=this.queryParameters, i_len=this.queryParameters.length, item;
        for (i=0; i<i_len; i++) {
        ...
        items = [];
        var i, i_items=this.headers, i_len=this.headers.length, item;
        for (i=0; i<i_len; i++) {
            item = this.headers[i];
            items.push(item.toJson());
        }
    ...
    method.prototype.getResponseStatuses = function() {
        var ret = [];
        if (this.responses) {
            var i, i_items=this.responses.responseStatuses, i_len=this.responses.responseStatuses.length, item;
            for (i=0; i<i_len; i++) {
    ...
    method.prototype.getMediaTypes = function() {
        var ret = [];
        var i, i_items=this.getResponseStatuses(), i_len=this.getResponseStatuses().length, rs;
        for (i=0; i<i_len; i++) {
            rs = this.getResponseStatuses()[i];
            if (rs.body) {
                var j, j_items=rs.body.mediaTypes, j_len=rs.body.mediaTypes.length, item;
                for (j=0; j<j_len; j++) {
...
var body = (function (ramlItem) {
    ...
    body.prototype.toJsonChildren = function(result) {
        ...
        var items, item;
        items = [];
        var i, i_items=this.formParameters, i_len=this.formParameters.length, item;
        for (i=0; i<i_len; i++) {
        ...
        items = [];
        var i, i_items=this.mediaTypes, i_len=this.mediaTypes.length, item;
        for (i=0; i<i_len; i++) {
...
var mediaType = (function (ramlItem) {
    ...
    mediaType.prototype.toJsonChildren = function(result) {
        ...
        result['properties'] = items;
        items = [];
        var i, i_items=this.examples, i_len=this.examples.length, item;
        for (i=0; i<i_len; i++) {
...
var responses = (function (ramlItem) {
    ...
    responses.prototype.toJsonChildren = function(result) {
        ...
        var items, item;
        items = [];
        var i, i_items=this.responseStatuses, i_len=this.responseStatuses.length, item;
        for (i=0; i<i_len; i++) {
...
var responseStatus = (function (ramlItem) {
    ...
    responseStatus.prototype.getMediaTypes = function() {
        ...
        if (_.isObject(this.body)) {
            var i, i_items=this.body.mediaTypes, i_len=this.body.mediaTypes.length, item;
            for (i=0; i<i_len; i++) {
...
var security = (function (ramlItem) {
    ...
    security.TYPE_NONE = "none";security.TYPE_OAUTH_1_0 = "OAuth.1.0";security.TYPE_OAUTH_2_0 = "OAuth.2.0";security.TYPE_BASIC = "Basic";security.TYPE_DIGEST = "Digest";security.TYPE_X__OTHER_ = "x-{other}";security.prototype.addSetting = function(name, sourceLineInfo) {
    ...
    security.prototype.toJsonChildren = function(result) {
        ...
        var items, item;
        items = [];
        var i, i_items=this.settings, i_len=this.settings.length, item;
        for (i=0; i<i_len; i++) {
...
var schema = (function (ramlItem) {
    ...
    schema.prototype.toJsonChildren = function(result) {
        ...
        var items, item;
        items = [];
        var i, i_items=this.typeItems, i_len=this.typeItems.length, item;
        for (i=0; i<i_len; i++) {
...
var typeItem = (function (ramlItem) {
    ...
    typeItem.TYPE_ANY = "any";typeItem.TYPE_OBJECT = "object";typeItem.TYPE_ARRAY = "array";typeItem.TYPE_UNION = "union";typeItem.TYPE_EXTERNAL = "external";typeItem.TYPE_STRING = "string";typeItem.TYPE_NUMBER = "number";typeItem.TYPE_INTEGER = "integer";typeItem.TYPE_XBOOLEAN = "boolean";typeItem.TYPE_DATETIME = "datetime";typeItem.TYPE_DATETIME_ONLY = "datetime-only";typeItem.TYPE_DATE_ONLY = "date-only";typeItem.TYPE_TIME_ONLY = "time-only";typeItem.TYPE_FILE = "file";typeItem.TYPE_NIL = "nil";typeItem.prototype.toJson = function() {
        var result = {};
        this.toJsonProperties(result);
        this.toJsonChildren(result);
        return result;
...
var property = (function (ramlBase) {
    ...
    property.TYPE_NUMBER = "number";property.TYPE_XBOOLEAN = "boolean";property.TYPE_STRING = "string";property.TYPE_DATE_ONLY = "date-only";property.TYPE_TIME_ONLY = "time-only";property.TYPE_DATETIME_ONLY = "datetime-only";property.TYPE_DATETIME = "datetime";property.TYPE_FILE = "file";property.TYPE_INTEGER = "integer";property.TYPE_NIL = "nil";property.prototype.toJson = function() {
        var result = {};
        this.toJsonProperties(result);
        this.toJsonChildren(result);
        return result;
...
var number = (function (scalar) {
    ...
    number.FORMAT_INT32 = "int32";number.FORMAT_INT64 = "int64";number.FORMAT_XINT = "int";number.FORMAT_XLONG = "long";number.FORMAT_XFLOAT = "float";number.FORMAT_XDOUBLE = "double";number.FORMAT_INT16 = "int16";number.FORMAT_INT8 = "int8";number.prototype.toJson = function() {
        var result = {};
        this.toJsonProperties(result);
        this.toJsonChildren(result);
        return result;
...
var datetime = (function (scalar) {
    ...
    datetime.FORMAT_NONE = "none";datetime.FORMAT_RFC3339 = "rfc3339";datetime.FORMAT_RFC2616 = "rfc2616";datetime.prototype.toJson = function() {
        var result = {};
        this.toJsonProperties(result);
        this.toJsonChildren(result);
        return result;
...
var file = (function (scalar) {
    ...
    file.prototype.toJsonChildren = function(result) {
        ...
        var items, item;
        items = [];
        var i, i_items=this.fileTypes, i_len=this.fileTypes.length, item;
        for (i=0; i<i_len; i++) {
...
var example = (function (ramlItem) {
    ...
    example.prototype.toJsonChildren = function(result) {
        ...
        var items, item;
        items = [];
        var i, i_items=this.jsonItems, i_len=this.jsonItems.length, item;
        for (i=0; i<i_len; i++) {
...
function initComments(comments) {
    ...
    for (i=0; i<i_len; i++) {
        ...
        if (item.comments && item.comments.length) {
            ...
            var j, j_items=item.comments, j_len=item.comments.length, c;
            for (j=0; j<j_len; j++) {
                c = item.comments[j];
                ret.push({
                    title: title, 
