/*
    ...
    primary source IttfDocument: C:\My\wizzi\wizzi-mono\packages\wizzi-js\.wizzi\ittf\examples\codegen\jsmodel\jsnode.js.ittf
*/
'use strict';
...
var JsNode = (function () {
    ...
    JsNode.prototype.addStatement = function(element, name) {
        ...
        else if (isAttribute(this.wzElement + '/' + checkKeyword(element))) {
