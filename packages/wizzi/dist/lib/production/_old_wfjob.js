/*
    ...
    primary source IttfDocument: C:\My\wizzi\wizzi-mono\packages\wizzi\.wizzi\ittf\lib\production\_old_wfjob.js.ittf
*/
'use strict';
...
var wfjob = (function () {
    ...
    */
    ...
    wfjob.prototype.getRequiredPackages = function(callback) {
        ...
        this.initialize(function(err, wfjobModel) {
            ...
            var result = [];
            var i, i_items=wfjobModel.requires, i_len=wfjobModel.requires.length, r;
            for (i=0; i<i_len; i++) {
    ...
    wfjob.prototype.getArtifactInfoConfigs = function(callback) {
        ...
        this.initialize(function(err, wfjobModel) {
            ...
            var i, i_items=wfjobModel.requires, i_len=wfjobModel.requires.length, require;
            for (i=0; i<i_len; i++) {
            ...
            */
            var i, i_items=wfjobModel.productions, i_len=wfjobModel.productions.length, wfjob_production;
            for (i=0; i<i_len; i++) {
                ...
                var j, j_items=wfjob_production.lines, j_len=wfjob_production.lines.length, wfjob_line;
                for (j=0; j<j_len; j++) {
                    ...
                    var k, k_items=wfjob_line.artifacts, k_len=wfjob_line.artifacts.length, wfjob_artifact;
                    for (k=0; k<k_len; k++) {
                        ...
                        if (verify.isEmpty(wfjob_artifact.src)) {
                            ...
                            */
                            ...
                            var l, l_items=wfjob_artifact.modelRefs, l_len=wfjob_artifact.modelRefs.length, modelRef;
                            for (l=0; l<l_len; l++) {
    ...
    */
    wfjob.prototype.createContextModelInfoConfig = function(wfjob_modelRef) {
        ...
        var i, i_items=wfjob_model.modelRefs, i_len=wfjob_model.modelRefs.length, ctxModelRef;
        for (i=0; i<i_len; i++) {
        ...
        */
        if (verify.isAbsolutePath(src)) {
            ...
            if (verify.isString(this.wfjobModel.modelsBaseFolder)) {
                ...
                console.log('wizzi.wfjob.node', node);
