/*
    ...
    primary source IttfDocument: C:\My\wizzi\wizzi\packages\wizzi\.wizzi\ittf\examples\js\index.js.ittf
*/
'use strict';
/**
...
generateArtifactsByNames([
    'basic'
], 'js', 'js/module', function(err, result) {
    if (err) {
        console.log('examples.js.generateArtifactsByNames.err', err);
        console.log('examples.js.generateArtifactsByNames.err.toString()', err.toString());
        if (err.inner) {
            console.log('examples.js.generateArtifactsByNames.err.inner.toString()', err.inner.toString());
        }
    }
    else {
        console.log('examples.js.generateArtifactsByNames.result', result);
    }
});
