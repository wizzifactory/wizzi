/*
    ...
    primary source IttfDocument: C:\My\wizzi\wizzi-mono\packages\wizzi\.wizzi\ittf\examples\js\index.js.ittf
*/
'use strict';
...
function execute(name, wf) {
    ...
    wf.loadModelAndGenerateArtifact(ittfSource, {}, 'js/module', function(err, artifactText) {
        if (err) {
            console.log('err', err);
            throw new Error(err.message);
        }
