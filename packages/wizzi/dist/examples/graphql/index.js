/*
    ...
    primary source IttfDocument: C:\My\wizzi\wizzi\packages\wizzi\.wizzi\ittf\examples\graphql\index.js.ittf
*/
'use strict';
/**
...
generateArtifactsByNames([
    'basic'
], 'graphql', 'graphql/document', function(err, result) {
    if (err) {
        console.log('examples.graphql.generateArtifactsByNames.err', err);
        console.log('examples.graphql.generateArtifactsByNames.err.toString()', err.toString());
        if (err.inner) {
            console.log('examples.graphql.generateArtifactsByNames.err.inner.toString()', err.inner.toString());
        }
    }
    else {
        console.log('examples.graphql.generateArtifactsByNames.result', result);
    }
});
