/*
    ...
    primary source IttfDocument: C:\My\wizzi\wizzi\packages\wizzi\.wizzi\ittf\examples\css\index.js.ittf
*/
'use strict';
/**
...
generateArtifactsByNames([
    'basic'
], 'css', 'css/document', function(err, result) {
    if (err) {
        console.log('examples.css.generateArtifactsByNames.err', err);
        console.log('examples.css.generateArtifactsByNames.err.toString()', err.toString());
        if (err.inner) {
            console.log('examples.css.generateArtifactsByNames.err.inner.toString()', err.inner.toString());
        }
    }
    else {
        console.log('examples.css.generateArtifactsByNames.result', result);
    }
});
