/*
    ...
    primary source IttfDocument: C:\My\wizzi\wizzi-mono\packages\wizzi-mtree\.wizzi\ittf\tests\all\loader\mocks\ittfDocumentStore.js.ittf
*/
'use strict';
...
var IttfDocumentStore = (function () {
    ...
    */
    IttfDocumentStore.prototype.init = function(ittfDocumentInfo, callback) {
        ...
        if (verify.isObject(ittfDocumentInfo) === false) {
            return callback(error(
                'InvalidArgument', 'init', { parameter: 'ittfDocumentInfo', message: 'The ittfDocumentInfo parameter must be an object. Received: ' + ittfDocumentInfo }
            ));
        }
        if (verify.isNotEmpty(ittfDocumentInfo.storeKind) === false) {
            return callback(error(
                'InvalidArgument', 'init', { parameter: 'ittfDocumentInfo.storeKind', message: 'The ittfDocumentInfo.storeKind parameter must be a string. Received: ' + ittfDocumentInfo.storeKind }
            ));
        }
    ...
    IttfDocumentStore.prototype.initSync = function(ittfDocumentInfo) {
        if (verify.isObject(ittfDocumentInfo) === false) {
            return error(
                'InvalidArgument', 'initSync', { parameter: 'ittfDocumentInfo', message: 'The ittfDocumentInfo parameter must be an object. Received: ' + ittfDocumentInfo }
            );
        }
        if (verify.isNotEmpty(ittfDocumentInfo.storeKind) === false) {
            return error(
                'InvalidArgument', 'initSync', { parameter: 'ittfDocumentInfo.storeKind', message: 'The ittfDocumentInfo.storeKind parameter must be a string. Received: ' + ittfDocumentInfo.storeKind }
            );
        }
        this.storeImpl = new FileSystemStore();
        this.storeKind = this.storeImpl.storeKind;
...
function error(code, method, message, innerError) {
    ...
    return verify.error(innerError, {
        ...
        method: 'wizzi-mtree.tests.mocks.ittfDocumentStore.' + method,
        parameter: parameter,
