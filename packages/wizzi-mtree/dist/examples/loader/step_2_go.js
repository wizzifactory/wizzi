/*
    ...
    primary source IttfDocument: C:\My\wizzi\wizzi-mono\packages\wizzi-mtree\.wizzi\ittf\examples\loader\step_2_go.js.ittf
*/
'use strict';
...
function heading1(text) {
    ...
    console.log('** level 0 - step 1 - loader_appender - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
function heading2(text) {
    ...
    console.log('   ','-- loader_appender - ' + text);
    console.log('   ', '-'.repeat(100));
    console.log('');
}
...
module.exports = loader_appender;
