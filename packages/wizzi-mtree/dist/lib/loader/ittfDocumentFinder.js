/*
    ...
    primary source IttfDocument: C:\My\wizzi\wizzi-mono\packages\wizzi-mtree\.wizzi\ittf\lib\loader\ittfDocumentFinder.js.ittf
*/
'use strict';
...
var IttfDocumentFinder = (function () {
    ...
    */
    ...
    IttfDocumentFinder.prototype.tryExists = function(test, schema, callback) {
        ...
        if (verify.isNotEmpty(schema) === false) {
            return callback(error(
                'InvalidArgument', 'tryExists', { parameter: 'schema', message: 'The schema parameter must be a string. Received: ' + schema }
            ));
        }
        var that = this;
