/*
    ...
    primary source IttfDocument: C:\My\wizzi\wizzi-mono\packages\wizzi-mtree\.wizzi\ittf\lib\loader\mixer.js.ittf
*/
'use strict';
        ...
        if (isMixinCall) {
            ...
            */
            mTreeBrickProvider.get({
                ...
                if (err) {
                    console.log('wizzi-mtree.loader.mixer.err', err);
                    console.log('wizzi-mtree.loader.mixer.mixerNode', mixerNode.name, mixerNode.value);
                    return callback(err);
                }
