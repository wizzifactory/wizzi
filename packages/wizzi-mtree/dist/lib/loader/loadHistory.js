/*
    ...
    primary source IttfDocument: C:\My\wizzi\wizzi-mono\packages\wizzi-mtree\.wizzi\ittf\lib\loader\loadHistory.js.ittf
*/
'use strict';
...
var LoadHistory = (function () {
    ...
    */
    ...
    LoadHistory._old_getLoadStateAsync_VIA = function(ittfDocumentUri, loadContext, callback) {
        if (!MTreeBrickProvider) {
            MTreeBrickProvider = require('./mTreeBrickProvider');
        }
        MTreeBrickProvider.createFromUri(ittfDocumentUri, loadContext, function(err, createdProvider) {
            if (err) {
                return callback(err);
            }
            callback(null, {
