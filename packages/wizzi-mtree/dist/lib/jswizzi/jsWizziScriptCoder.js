/*
    ...
    primary source IttfDocument: C:\my\wizzi\wizzi\packages\wizzi-mtree\.wizzi\ittf\lib\jswizzi\jsWizziScriptCoder.js.ittf
*/
'use strict';
...
var JsWizziScriptCoder = (function () {
    ...
    JsWizziScriptCoder.prototype.w = function(text, node) {
    ...
    JsWizziScriptCoder.prototype.getNodeFromScriptMap = function(line) {
        if (this.map[line]) {
            return this.map[line];
        }
        else if (this.map[line-1]) {
