/*
    ...
    primary source IttfDocument: C:\My\wizzi\wizzi-mono\packages\wizzi-utils\.wizzi\ittf\lib\fs\vfile.js.ittf
*/
'use strict';
...
var VFile = (function () {
    ...
    VFile.prototype.copyFileAsync = function(path_string, dest, options, callback) {
        ...
        this.isFile(src, function(err, result) {
            ...
            if (result == false) {
                return callback(null, new Error(`Source '${src}' is not a file`));
            }
    ...
    VFile.prototype.copyFolderAsync = function(path_string, dest, options, callback) {
        ...
        this.isDirectory(src, function(err, result) {
            ...
            if (result == false) {
                return callback(null, new Error(`Source '${src}' is not a directory`));
            }
