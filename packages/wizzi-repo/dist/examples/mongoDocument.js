/*
    ...
    primary source IttfDocument: C:\My\wizzi\wizzi-mono\packages\wizzi-repo\.wizzi\ittf\examples\mongoDocument.js.ittf
*/
'use strict';

/**
     EXAMPLE: wizzi-repo.examples.mongoDocument
*/

var myname = 'wizzi-repo.examples.mongoDocument';
...
heading1('start');
Document.create(function(err, doc) {
    if (err) {
        console.log('err', err);
    ...
    function _createWriteStream() {
        doc.createWriteStream(file_7_path, function(err, stream) {
            if (err) {
                console.log('err', err);
                throw new Error(err.message);
            }
...
function heading1(text) {
    console.log('');
    console.log('********************************************************************************');
    console.log('** Example wizzi-repo.examples.mongoDocument - ' + text);
    console.log('********************************************************************************');
    console.log('');
}
