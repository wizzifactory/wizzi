/*
    ...
    primary source IttfDocument: C:\My\wizzi\wizzi-mono\packages\wizzi-repo\.wizzi\ittf\lib\json\fs\document.js.ittf
*/
'use strict';
...
var Document = (function () {
    ...
    Document.prototype.writeFile = function(filePath, content, callback) {
        ...
        // log 'wizzi-repo.fs.json.document.writeFile.writeFile.init', filePath
        filePath = normalize(filePath);
        // log 'wizzi-repo.fs.json.document.writeFile.writeFile.normalized', filePath
        var that = this;
        this.fsCommon.getItemByPath(filePath, function(err, fsitem) {
            if (err) {
                return callback(err);
