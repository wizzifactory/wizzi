/*
    ...
    primary source IttfDocument: C:\My\wizzi\wizzi-mono\packages\wizzi-repo\.wizzi\ittf\lib\mongodb\fs\document.js.ittf
*/
'use strict';
...
var Document = (function () {
    ...
    Document.prototype.copyFile = function(sourcePath, destPath, callback) {
        ...
        this.readFile(sourcePath, function(err, source) {
            ...
            that.exists(destPath, function(err, result) {
                ...
                if (result === true) {
                    return callback(error('MongoFSRepoError', 'copyFile', 'Document copy file error. The destination path already exists: ' + destPath));
                }
                else {
    ...
    Document.prototype.deleteFile = function(filePath, callback) {
        ...
        this.fsCommon.getItemByPath(filePath, function(err, fsitem) {
            ...
            if (fsitem == null) {
                return callback(error('MongoFSRepoError', 'deleteFolder', 'Document delete file error. Item not found: ' + filePath));
            }
            if (fsitem.kind == 0) {
                return callback(error('MongoFSRepoError', 'deleteFolder', 'Document delete file error. Is a folder path, not a file path: ' + filePath));
            }
    ...
    Document.prototype.deleteFolder = function(folderPath, callback) {
        ...
        this.fsCommon.getItemByPath(folderPath, function(err, fsitem) {
            ...
            if (fsitem == null) {
                return callback(error('MongoFSRepoError', 'deleteFolder', 'Document folder not found: ' + folderPath));
            }
            if (fsitem.kind == 1) {
                return callback(error('MongoFSRepoError', 'deleteFolder', 'Is a file path, not a folder path: ' + folderPath));
            }
    ...
    Document.prototype.renameFile = function(oldPath, newPath, callback) {
        ...
        this.fsCommon.getItemByPath(oldPath, function(err, fsitem) {
            ...
            if (fsitem == null) {
                return callback(error('MongoFSRepoError', 'renameFile', 'Document rename file error. Old path not found: ' + oldPath));
            }
            if (fsitem.kind == 0) {
            ...
            that.exists(newPath, function(err, r) {
                ...
                if (r === true) {
                    return callback(error('MongoFSRepoError', 'renameFile', 'Document rename file error. The new path already exists: ' + newPath));
                }
                else {
    ...
    Document.prototype.renameFolder = function(oldPath, newPath, callback) {
        ...
        this.fsCommon.getItemByPath(oldPath, function(err, fsitem) {
            ...
            if (fsitem == null) {
                return callback(error('MongoFSRepoError', 'renameFolder', 'Document rename folder error. Old path not found: ' + oldPath));
            }
            if (fsitem.kind == 1) {
            ...
            that.exists(newPath, function(err, r) {
                ...
                if (r === true) {
                    return callback(error('MongoFSRepoError', 'renameFile', 'Document rename folder error. The new path already exists: ' + newPath));
                }
                else {
                    fsitem.basename = newName;
                    fsitem.path = normalize(path.join(fsitem.dirname, fsitem.basename));
...
function error(code, method, message, innerError) {
    ...
    return verify.error(innerError, {
        ...
        method: 'wizzi-repo.fs.mongodb.Document.' + method,
        parameter: parameter,
