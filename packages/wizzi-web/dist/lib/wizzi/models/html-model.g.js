...
var htmlBase = (function () {
    ...
    htmlBase.prototype.wzSourceErrorLines = function(node, message) {
...
var element = (function (htmlBase) {
    ...
    element.prototype.loadChild = function(child) {
        ...
        if (name === '::style') {
            ...
            return this.wzLoadToChildColl(child, _md.svgInclude, this.elements);
        }
        else if (name === '::ready') {
            return this.wzLoadToChildColl(child, _md.readyInclude, this.elements);
        }
        if (name === 'address') {
        ...
        else if (name === 'ittfpanel') {
            return this.wzLoadToChildColl(child, _md.ittfPanel, this.elements);
        }
        if (name === 'translate') {
        ...
        if (name === '::dataarray') {
            return this.wzLoadToChildColl(child, _md.jsonArrayInclude, this.elements);
        }
        if (name === 'contextmenu') {
            this.contextmenu = child.v; return true;
        }
        if (name === '::dataobject') {
            return this.wzLoadToChildColl(child, _md.jsonObjectInclude, this.elements);
        }
...
var script = (function (element) {
    ...
    script.prototype.loadChild = function(child) {
        ...
        if (name === 'integrity') {
            this.integrity = child.v; return true;
        }
        if (name === 'crossorigin') {
            this.crossorigin = child.v; return true;
        }
...
var table = (function (element) {
    ...
    table.prototype.loadChild = function(child) {
        var ok = false, name = child.n.toLowerCase();
        if (name === 'rule') {
            this.rule = child.v; return true;
        }
        if (name === 'align') {
            this.align = child.v; return true;
        }
        if (name === 'frame') {
            this.frame = child.v; return true;
        }
        if (name === 'width') {
            this.width = child.v; return true;
        }
        ...
        if (name === 'bgcolor') {
            this.bgcolor = child.v; return true;
        }
        if (name === 'summary') {
            this.summary = child.v; return true;
        }
        if (name === 'sortable') {
...
var ready = (function (element) {
    ...
    ready.KIND_JQUERY = "jquery";ready.KIND_WINDOW = "window";ready.prototype.addStatement = function(name, sourceLineInfo) {
        var retval = new _md.statement(name, sourceLineInfo);
        retval.wzParent = this;
        this.statements.push(retval);
        return retval;
        ...
        if (typeof this.wzName === 'string' && this.wzName.length > 0) {
            ...
            if (this.wzParent && this.wzParent.getAscendingRuleParts) {
                ...
                for (i=0; i<i_len; i++) {
                    ...
                    var j, j_items=ruleParts, j_len=ruleParts.length, rp;
                    for (j=0; j<j_len; j++) {
                        rp = ruleParts[j];
                        ret.push(prp + ' ' + rp);
                    }
...
var lorem = (function (element) {
    ...
    lorem.UNITS_WORDS = "words";lorem.UNITS_SENTENCES = "sentences";lorem.UNITS_PARAGRAPHS = "paragraphs";lorem.prototype.loadChild = function(child) {
        var ok = false, name = child.n.toLowerCase();
        if (name === 'units') {
...
_md.lorem = lorem;
// element ittfPanel
var ittfPanel = (function (element) {
    _inherits(ittfPanel, element);
...
var cssInclude = (function (element) {
    ...
    cssInclude.prototype.loadChild = function(child) {
        ...
        if (name === 'scoped') {
            this.scoped = parseboolean(child.v, null, child); return true;
        }
        ok = _md.element.prototype.loadChild.call(this, child);
        return ok;
    }
...
// element svgInclude
var svgInclude = (function (element) {
    _inherits(svgInclude, element);
    function svgInclude(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(svgInclude.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, svgInclude);
        this.wzElement = "svgInclude";
        this.svg_svg_items = [];
    }
    svgInclude.prototype.loadChild = function(child) {
        var ok = false, name = child.n.toLowerCase();
        if (name === 'svg') {
            // generated by wizzi/lib/wizzi/models/bootstrap/t/wfschema/t/element_load;
            this.svg_svg_items.push(child);
    ...
    svgInclude.prototype.loadFromNode = function(node) {
        node.children.forEach((item) => {
            var loaded = this.loadChild(item);
            if (!loaded) {
                throw new _md.htmlModelException("Tag not recognized: " + item.n, item, this);
...
_md.svgInclude = svgInclude;
// element jsonObjectInclude
var jsonObjectInclude = (function (element) {
    _inherits(jsonObjectInclude, element);
...
var jsonArrayInclude = (function (element) {
    _inherits(jsonArrayInclude, element);
...
// element readyInclude
var readyInclude = (function (element) {
    _inherits(readyInclude, element);
    function readyInclude(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(readyInclude.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, readyInclude);
        this.wzElement = "readyInclude";
        this.js_module_items = [];
    }
    readyInclude.prototype.loadChild = function(child) {
        var ok = false, name = child.n.toLowerCase();
        if (name === 'module') {
            // generated by wizzi/lib/wizzi/models/bootstrap/t/wfschema/t/element_load;
            this.js_module_items.push(child);
    ...
    readyInclude.prototype.loadFromNode = function(node) {
        node.children.forEach((item) => {
            var loaded = this.loadChild(item);
            if (!loaded) {
                throw new _md.htmlModelException("Tag not recognized: " + item.n, item, this);
...
_md.readyInclude = readyInclude;
_md.__tagElementMapping = { '@': 'attribute', '<': 'element', 'var': 'xvar', '.': '_dot', '#': '_sharp', 'js': '_js', 'js-babel': 'jsBabel', 'jsbabel': 'jsBabel', 'css': '_css', '+': '_text', '++': '_textLF', '-': 'comment', '@title': '_title', '@style': '_style', 'ittf-panel': 'ittfPanel', 'ittfpanel': 'ittfPanel', '::script': 'jsInclude', '::style': 'cssInclude', '::media': 'svgInclude', '::data-object': 'jsonObjectInclude', '::dataobject': 'jsonObjectInclude', '::data-array': 'jsonArrayInclude', '::dataarray': 'jsonArrayInclude', '::ready': 'readyInclude', 'function': 'xfunction', '_': 'call', 'if': 'xif', 'else': 'xelse', 'for': 'xfor', 'while': 'xwhile', 'try': 'xtry', 'catch': 'xcatch', '{': 'jsObject', '[': 'jsArray' };
...
var htmlModelException = (function () {
    ...
    htmlModelException.prototype.toString = function() {
        var msg = [];
        msg.push(chalk.red('Error: ' + this.message));
        msg.push(chalk.red('  name: htmlModelException'));
        if (this.node) {
...
function parseboolean(value, defaultValue, node) {
    ...
    if (!isBoolean(value)) {
        throw new htmlModelException('Must be a boolean value (\"true\" or \"false\"), got:' + value, node);
    }
