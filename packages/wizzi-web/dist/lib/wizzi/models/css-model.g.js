...
var cssBase = (function () {
    ...
    cssBase.prototype.wzSourceErrorLines = function(node, message) {
    ...
    cssBase.prototype.wzAddChildToColl = function(node, coll) {
        node.wzParent = this;
        node.wzMoved = true;
        coll.push(node);
    }
    cssBase.prototype.wzMoveChildToColl = function(node, coll, fromColl) {
    ...
    cssBase.prototype.wzCreateChildColl = function(tag, name, type, coll) {
    ...
    cssBase.prototype.wzRemove = function(fromColl) {
    ...
    cssBase.prototype.error = function(message, node) {
        throw new _md.cssModelException(message, node, this);
    }
    return cssBase;
})();
...
var css = (function (cssBase) {
    ...
    css.prototype.loadChild = function(child) {
        ...
        if (name === '%') {
            return this.wzLoadToChildColl(child, _md.placeholder, this.rules);
        }
        if (name === '&') {
            return this.wzLoadToChildColl(child, _md.ampersand, this.rules);
        }
        if (name === '-') {
            return this.wzLoadToChildColl(child, _md.comment, this.rules);
        }
        else if (name === '-') {
        ...
        if (name === '>') {
            return this.wzLoadToChildColl(child, _md.gtRule, this.rules);
        }
        if (name === '+&') {
            return this.wzLoadToChildColl(child, _md.otherAmpersandSelector, this.rules);
        }
        if (name === 'media') {
            return this.wzLoadToChildColl(child, _md.media, this.rules);
        }
        if (name === 'extend') {
            return this.wzLoadToChildColl(child, _md.extend, this.rules);
        }
        else if (name === 'extend') {
            return this.wzLoadToChildColl(child, _md.extend, this.rules);
        }
        if (name === 'import') {
            return this.wzLoadToChildColl(child, _md.ximport, this.rules);
        }
        if (name === 'charset') {
            this.charset = child.v; return true;
        }
        if (name === 'include') {
            return this.wzLoadToChildColl(child, _md.include, this.rules);
        }
        if (name === 'fontface') {
            return this.wzLoadToChildColl(child, _md.fontface, this.rules);
        }
        if (name === 'keyframe') {
            return this.wzLoadToChildColl(child, _md.keyframe, this.rules);
        }
        if (name === 'resource') {
        ...
        if (name === 'keyframes') {
            return this.wzLoadToChildColl(child, _md.keyframes, this.rules);
        }
        if (name === 'use-normalize') {
            this.useNormalize = parseboolean(child.v, true, child); return true;
        }
        else if (name === 'use_normalize') {
            this.useNormalize = parseboolean(child.v, true, child); return true;
        }
        return false;
    }
    css.prototype.loadFromNode = function(node) {
        node.children.forEach((item) => {
            ...
            if (!loaded) {
                throw new _md.cssModelException("Tag not recognized: " + item.n, item, this);
            }
        });
    }
    css.prototype.wzVerify = function(ctx) {
        ...
        _md.cssBase.prototype.wzVerify.call(this, ctx);
    }
    css.prototype.wzInitialize = function(ctx) {
        ...
        if (verify.isObject(this.extends)) {
            var rule;
            var i, i_items=Object.keys(this.extends), i_len=Object.keys(this.extends).length, item;
            for (i=0; i<i_len; i++) {
                item = Object.keys(this.extends)[i];
                rule = this.findRuleBySelector(item);
                if (rule) {
                    var j, j_items=this.extends[item], j_len=this.extends[item].length, ext;
                    for (j=0; j<j_len; j++) {
                        ext = this.extends[item][j];
                        rule.addOtherRuleSelector(ext.wzParent.getSelector(), this.wzSourceLineInfo);
                    }
                    rule.ruleParts = rule.getAscendingRuleParts();
                }
            }
        }
        _md.cssBase.prototype.wzInitialize.call(this, ctx);
    }
    css.prototype.findRuleBySelector = function(name) {
        var ret = null;
...
var rule = (function (cssBase) {
    ...
    function rule(name, sourceLineInfo) {
        ...
        // relation otherClassSelector
        this.otherClassSelectors = [];
        // relation otherAmpersandSelector
        this.otherAmpersandSelectors = [];
        // relation property
        this.properties = [];
        // relation rule
        this.rules = [];
    ...
    rule.prototype.addOtherClassSelector = function(name, sourceLineInfo) {
        var retval = new _md.otherClassSelector(name, sourceLineInfo);
        retval.wzParent = this;
        this.otherClassSelectors.push(retval);
        return retval;
    }
    rule.prototype.getOtherClassSelector = function(name) {
        var found = null;
        this.otherClassSelectors.forEach(function(item) {
            found = found || (item.wzName === name ? item : null);
        });
        return found;
    }
    rule.prototype.addOtherAmpersandSelector = function(name, sourceLineInfo) {
        var retval = new _md.otherAmpersandSelector(name, sourceLineInfo);
        retval.wzParent = this;
        this.otherAmpersandSelectors.push(retval);
        return retval;
    }
    rule.prototype.getOtherAmpersandSelector = function(name) {
        var found = null;
        this.otherAmpersandSelectors.forEach(function(item) {
            found = found || (item.wzName === name ? item : null);
        });
        return found;
    }
    ...
    rule.prototype.loadChild = function(child) {
        ...
        if (name === '+.') {
            return this.wzLoadToChildColl(child, _md.otherClassSelector, this.otherClassSelectors);
        }
        else if (name === '+&') {
            return this.wzLoadToChildColl(child, _md.otherAmpersandSelector, this.otherAmpersandSelectors);
        }
        else if (name === '+&') {
            return this.wzLoadToChildColl(child, _md.otherAmpersandSelector, this.rules);
        }
        ...
        if (name === 'fontfeaturesettings') {
            return this.wzLoadToChildColl(child, _md.font_feature_settings, this.properties);
        }
    ...
    rule.prototype.wzVerify = function(ctx) {
        this.otherRuleSelectors.forEach((item) => {
            item.wzVerify(ctx);
        });
        this.otherClassSelectors.forEach((item) => {
            item.wzVerify(ctx);
        });
        this.otherAmpersandSelectors.forEach((item) => {
            item.wzVerify(ctx);
        });
    ...
    rule.prototype.getProperties = function() {
        ...
        for (var prop in this) {
            if (isPropValue(prop, this[prop])) {
                retval.push({ name: verify.replaceAll(prop, '_', '-'), value: this[prop] });
            }
        }
        ...
        for (i=0; i<i_len; i++) {
            ...
            if (prop.wzElement === 'property') {
                ...
                else if (verify.isNotEmpty(prop.wzName)) {
                    retval.push({ name: prop.wzTag, value: prop.wzName });
                }
                for (var attr in prop) {
                    if (isPropValue(attr, prop[attr])) {
                        retval.push({ name: prop.wzTag + '-' + verify.replaceAll(attr, '_', '-'), value: prop[attr] });
                    }
                }
            }
        }
    ...
    rule.prototype.getAscendingRuleParts = function() {
        ...
        if (this.wzElement !== 'media') {
            thisRuleParts = this.wzName.trim().split(',');
            var i, i_items=this.otherRuleSelectors, i_len=this.otherRuleSelectors.length, ors;
            for (i=0; i<i_len; i++) {
                ors = this.otherRuleSelectors[i];
                thisRuleParts.push(ors.wzName);
            }
        }
        if (thisRuleParts.length > 0) {
            if (this.wzElement === 'idRule') {
                thisRuleParts[0] = '#' + thisRuleParts[0];
            }
            else if (this.wzElement === 'classRule') {
                thisRuleParts[0] = '.' + thisRuleParts[0];
            }
            else if (this.wzElement === 'gtRule') {
                thisRuleParts[0] = '> ' + thisRuleParts[0];
            }
            else if (this.wzElement === 'placeholder') {
                thisRuleParts[0] = '%' + thisRuleParts[0];
            }
            else if (this.wzElement === 'ampersand') {
                thisRuleParts[0] = '&' + thisRuleParts[0];
            }
        }
        if (this.wzParent && this.wzParent.getAscendingRuleParts) {
            ...
            if (parentRuleParts.length > 0) {
                var ret = [];
                var i, i_items=parentRuleParts, i_len=parentRuleParts.length, prp;
                for (i=0; i<i_len; i++) {
                    ...
                    if (this.wzElement == 'media') {
                        ...
                        var j, j_items=thisRuleParts, j_len=thisRuleParts.length, rp;
                        for (j=0; j<j_len; j++) {
                            rp = thisRuleParts[j];
                            if (rp.indexOf('&') > -1) {
                                ret.push(verify.replaceAll(rp, '&', prp));
                            }
                            else {
                                ret.push(prp + ' ' + rp);
                            }
...
/**
    element gtRule
     ...
     The wzName contain the selector(s)
*/
var gtRule = (function (rule) {
    _inherits(gtRule, rule);
    function gtRule(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(gtRule.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, gtRule);
        this.wzElement = "gtRule";
    }
    return gtRule;
})(rule);
...
_md.gtRule = gtRule;
// element ampersand
var ampersand = (function (rule) {
    _inherits(ampersand, rule);
...
// element placeholder
var placeholder = (function (rule) {
    _inherits(placeholder, rule);
...
/**
    element otherClassSelector
     ...
     for: .container, .item ...
*/
var otherClassSelector = (function (cssBase) {
    _inherits(otherClassSelector, cssBase);
    function otherClassSelector(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(otherClassSelector.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, otherClassSelector);
        this.wzElement = "otherClassSelector";
    }
    return otherClassSelector;
})(cssBase);

_md.otherClassSelector = otherClassSelector;
// element otherAmpersandSelector
var otherAmpersandSelector = (function (rule) {
    _inherits(otherAmpersandSelector, rule);
    function otherAmpersandSelector(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(otherAmpersandSelector.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, otherAmpersandSelector);
        this.wzElement = "otherAmpersandSelector";
    }
    return otherAmpersandSelector;
})(rule);

_md.otherAmpersandSelector = otherAmpersandSelector;
/**
    element property
...
_md.font = font;
// element font_feature_settings
var font_feature_settings = (function (property) {
    _inherits(font_feature_settings, property);
    function font_feature_settings(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(font_feature_settings.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, font_feature_settings);
        this.wzElement = "font_feature_settings";
    }
    return font_feature_settings;
})(property);

_md.font_feature_settings = font_feature_settings;
// element font_family
...
_md.fontface = fontface;
// element extend
var extend = (function (rule) {
    _inherits(extend, rule);
    function extend(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(extend.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, extend);
        this.wzElement = "extend";
    }
    extend.prototype.wzInitialize = function(ctx) {
        var root = this.wzRoot();
        if (!root.extends) {
            root.extends = {};
        }
        if (!root.extends[this.wzName]) {
            root.extends[this.wzName] = [];
        }
        root.extends[this.wzName].push(this);
...
var cssModelException = (function () {
    ...
    cssModelException.prototype.toString = function() {
        var msg = [];
        msg.push(chalk.red('Error: ' + this.message));
        msg.push(chalk.red('  name: cssModelException'));
        if (this.node) {
    ...
    return cssModelException;
})();

_md.cssModelException = cssModelException;
...
function parseboolean(value, defaultValue, node) {
    ...
    if (!isBoolean(value)) {
        throw new cssModelException('Must be a boolean value (\"true\" or \"false\"), got:' + value, node);
    }
