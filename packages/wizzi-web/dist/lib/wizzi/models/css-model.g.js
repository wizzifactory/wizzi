...
var css = (function (cssBase) {
    ...
    css.prototype.wzVerify = function(ctx) {
        var i, i_items=this.resources, i_len=this.resources.length, item;
        for (i=0; i<i_len; i++) {
...
var rule = (function (cssBase) {
    ...
    rule.prototype.wzVerify = function(ctx) {
        var i, i_items=this.otherRuleSelectors, i_len=this.otherRuleSelectors.length, item;
        for (i=0; i<i_len; i++) {
            item = this.otherRuleSelectors[i];
            item.wzVerify(ctx);
        }
        var i, i_items=this.otherClassSelectors, i_len=this.otherClassSelectors.length, item;
        for (i=0; i<i_len; i++) {
            item = this.otherClassSelectors[i];
            item.wzVerify(ctx);
        }
        var i, i_items=this.otherAmpersandSelectors, i_len=this.otherAmpersandSelectors.length, item;
        for (i=0; i<i_len; i++) {
            item = this.otherAmpersandSelectors[i];
            item.wzVerify(ctx);
        }
