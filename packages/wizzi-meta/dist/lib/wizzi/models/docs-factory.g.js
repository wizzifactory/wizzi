/*
    ...
    utc time: Wed, 24 Apr 2019 06:08:05 GMT
*/
'use strict';
/**
...
md.createLoadModel = function(wizziObject) {
    ...
    function loadModelFromMTree(mTree, ittfDocumentUri, wizziModelRequest, options, callback) {
        ...
        if (mTree.nodes.length == 0) {
            ...
            docsmodel.wzFactory = options.wizziFactory;
            try {
                // this is a sync call
                docsmodel.loadFromNode(rootNode);
            } 
            catch (ex) {
                var error = new errors.WizziModelLoadError(ex.message + '\nIn docs Factory, calling loadFromNode.', ittfDocumentUri, ex);
    ...
    if (options.loadFromMTree) {
        /**
             Load a WizziModel of type 'docs' from an mTree
        */
