...
var docs = (function (docsBase) {
    ...
    docs.prototype.toPrettifyProperties = function(ctx) {
        _md.docsBase.prototype.toPrettifyProperties.call(this, ctx);
    }
    docs.prototype.toPrettifyChildren = function(ctx) {
        _md.docsBase.prototype.toPrettifyChildren.call(this, ctx);
        var i, i_items=this.items, i_len=this.items.length, item;
        for (i=0; i<i_len; i++) {
            item = this.items[i];
            item.toPrettify(ctx);
...
var project = (function (item) {
    ...
    project.prototype.toPrettifyProperties = function(ctx) {
        _md.item.prototype.toPrettifyProperties.call(this, ctx);
    }
    project.prototype.toPrettifyChildren = function(ctx) {
        _md.item.prototype.toPrettifyChildren.call(this, ctx);
    }
...
var ittf = (function (item) {
    ...
    ittf.KIND_PRIMARY = "primary";ittf.KIND_MIXIN = "mixin";ittf.KIND_INCLUDE = "include";ittf.KIND_SCHEMA = "schema";ittf.prototype.toJson = function() {
        var result = {};
        this.toJsonProperties(result);
        this.toJsonChildren(result);
        return result;
