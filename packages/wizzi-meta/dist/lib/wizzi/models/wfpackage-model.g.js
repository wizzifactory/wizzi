...
var wfpackageBase = (function () {
    ...
    wfpackageBase.prototype.wzSourceErrorLines = function(node, message) {
...
var wfpackage = (function (commentable) {
    ...
    wfpackage.KIND_ITTFSOURCE = "ittfsource";wfpackage.KIND_KERNEL = "kernel";wfpackage.KIND_PLUGIN = "plugin";wfpackage.KIND_DEMO = "demo";wfpackage.prototype.addSchema = function(name, sourceLineInfo) {
    ...
    wfpackage.prototype.toJsonChildren = function(result) {
        ...
        items = [];
        var i, i_items=this.folders, i_len=this.folders.length, item;
        for (i=0; i<i_len; i++) {
            item = this.folders[i];
            items.push(item.toJson());
        }
        ...
        items = [];
        var i, i_items=this.documents, i_len=this.documents.length, item;
        for (i=0; i<i_len; i++) {
...
var fsInfo = (function (commentable) {
    ...
    fsInfo.prototype.toJsonChildren = function(result) {
        ...
        var items, item;
        items = [];
        var i, i_items=this.documentGroups, i_len=this.documentGroups.length, item;
        for (i=0; i<i_len; i++) {
...
var documentGroup = (function (commentable) {
    ...
    documentGroup.TYPE_SCHEMA = "schema";documentGroup.TYPE_FOLDER = "folder";documentGroup.prototype.addDocument = function(name, sourceLineInfo) {
        var retval = new _md.document(name, sourceLineInfo);
        retval.wzParent = this;
        this.documents.push(retval);
        return retval;
...
var ittf = (function (commentable) {
    ...
    ittf.prototype.toJsonChildren = function(result) {
        ...
        var items, item;
        items = [];
        var i, i_items=this.fragmentRefs, i_len=this.fragmentRefs.length, item;
        for (i=0; i<i_len; i++) {
