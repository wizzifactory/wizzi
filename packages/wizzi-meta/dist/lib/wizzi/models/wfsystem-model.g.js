/*
    ...
    utc time: Wed, 24 Apr 2019 06:08:03 GMT
*/
'use strict';
...
var wfsystemBase = (function () {
    ...
    wfsystemBase.prototype.wzSourceErrorLines = function(node, message) {
...
var wfsystem = (function (commentable) {
    ...
    wfsystem.prototype.toJsonChildren = function(result) {
        ...
        var items, item;
        items = [];
        var i, i_items=this.packages, i_len=this.packages.length, item;
        for (i=0; i<i_len; i++) {
        ...
        items = [];
        var i, i_items=this.apis, i_len=this.apis.length, item;
        for (i=0; i<i_len; i++) {
            item = this.apis[i];
            items.push(item.toJson());
        }
...
var xpackage = (function (commentable) {
    ...
    xpackage.KIND_ITTFSOURCE = "ittfsource";xpackage.KIND_KERNEL = "kernel";xpackage.KIND_PLUGIN = "plugin";xpackage.KIND_DEMO = "demo";xpackage.prototype.addSchema = function(name, sourceLineInfo) {
    ...
    xpackage.prototype.toJsonChildren = function(result) {
        ...
        var items, item;
        items = [];
        var i, i_items=this.schemas, i_len=this.schemas.length, item;
        for (i=0; i<i_len; i++) {
            item = this.schemas[i];
            items.push(item.toJson());
        }
        ...
        items = [];
        var i, i_items=this.generatedPackages, i_len=this.generatedPackages.length, item;
        for (i=0; i<i_len; i++) {
    ...
    xpackage.prototype.getJobs = function() {
        ...
        var i, i_items=this.buildCwds, i_len=this.buildCwds.length, item;
        for (i=0; i<i_len; i++) {
...
var schema = (function (commentable) {
    ...
    schema.prototype.toJsonChildren = function(result) {
        ...
        var items, item;
        items = [];
        var i, i_items=this.transformers, i_len=this.transformers.length, item;
        for (i=0; i<i_len; i++) {
        ...
        items = [];
        var i, i_items=this.artifacts, i_len=this.artifacts.length, item;
        for (i=0; i<i_len; i++) {
...
var artifact = (function (commentable) {
    ...
    artifact.KIND_ITTF = "ittf";artifact.KIND_CODEWRITE = "codewrite";artifact.prototype.toJson = function() {
        var result = {};
        this.toJsonProperties(result);
        this.toJsonChildren(result);
        return result;
...
var generatedPackage = (function (commentable) {
    ...
    generatedPackage.KIND_KERNEL = "kernel";generatedPackage.KIND_PLUGIN = "plugin";generatedPackage.KIND_DEMO = "demo";generatedPackage.prototype.addBuildCwd = function(name, sourceLineInfo) {
...
var api = (function (commentable) {
    ...
    api.KIND_KERNEL = "kernel";api.KIND_PLUGIN = "plugin";api.prototype.toJson = function() {
        var result = {};
        this.toJsonProperties(result);
        this.toJsonChildren(result);
        return result;
...
var implementation = (function (commentable) {
    ...
    implementation.TYPE_MODULE = "module";implementation.TYPE_POJO = "pojo";implementation.TYPE_CLASS_INSTANCE = "class-instance";implementation.prototype.toJson = function() {
        var result = {};
        this.toJsonProperties(result);
        this.toJsonChildren(result);
        return result;
...
var method = (function (commentable) {
    ...
    method.TYPE_XFUNCTION = "function";method.TYPE_HIGH_ORDER_FUNCTION = "high-order-function";method.TYPE_FACADE_FUNCTION = "facade-function";method.prototype.addParam = function(name, sourceLineInfo) {
...
var param = (function (commentable) {
    ...
    param.TYPE_STRING = "string";param.TYPE_XBOOLEAN = "boolean";param.TYPE_INTEGER = "integer";param.TYPE_XFLOAT = "float";param.TYPE_DATE = "date";param.TYPE_OBJECT = "object";param.TYPE_ANY = "any";param.TYPE_ARRAY = "array";param.TYPE_XFUNCTION = "function";param.TYPE_ALTERNATIVE = "alternative";param.TYPE_CALLBACK_FUNCTION = "callback-function";param.prototype.addValue = function(name, sourceLineInfo) {
...
var argument = (function (commentable) {
    ...
    argument.TYPE_STRING = "string";argument.TYPE_XBOOLEAN = "boolean";argument.TYPE_INTEGER = "integer";argument.TYPE_XFLOAT = "float";argument.TYPE_DATE = "date";argument.TYPE_OBJECT = "object";argument.TYPE_ANY = "any";argument.TYPE_ARRAY = "array";argument.TYPE_XFUNCTION = "function";argument.TYPE_ALTERNATIVE = "alternative";argument.TYPE_XSWITCH = "switch";argument.TYPE_EXCEPTION = "exception";argument.prototype.addValue = function(name, sourceLineInfo) {
        var retval = new _md.value(name, sourceLineInfo);
        retval.wzParent = this;
        this.values.push(retval);
        return retval;
    ...
    argument.prototype.toJsonChildren = function(result) {
        ...
        result['values'] = items;
        items = [];
        var i, i_items=this.ons, i_len=this.ons.length, item;
        for (i=0; i<i_len; i++) {
            item = this.ons[i];
            items.push(item.toJson());
        }
...
var value = (function (commentable) {
    ...
    value.TYPE_STRING = "string";value.TYPE_XBOOLEAN = "boolean";value.TYPE_INTEGER = "integer";value.TYPE_XFLOAT = "float";value.TYPE_DATE = "date";value.TYPE_OBJECT = "object";value.TYPE_ANY = "any";value.TYPE_ARRAY = "array";value.TYPE_XFUNCTION = "function";value.TYPE_XNULL = "null";value.TYPE_JSON = "json";value.TYPE_EXCEPTION = "exception";value.prototype.addProperty = function(name, sourceLineInfo) {
        var retval = new _md.property(name, sourceLineInfo);
        retval.wzParent = this;
        this.properties.push(retval);
        return retval;
    ...
    value.prototype.toJsonChildren = function(result) {
        ...
        result['items'] = items;
        items = [];
        var i, i_items=this.errors, i_len=this.errors.length, item;
        for (i=0; i<i_len; i++) {
            item = this.errors[i];
            items.push(item.toJson());
        }
...
var item = (function (commentable) {
    ...
    item.TYPE_STRING = "string";item.TYPE_XBOOLEAN = "boolean";item.TYPE_INTEGER = "integer";item.TYPE_XFLOAT = "float";item.TYPE_DATE = "date";item.TYPE_OBJECT = "object";item.TYPE_ANY = "any";item.TYPE_ARRAY = "array";item.TYPE_XFUNCTION = "function";item.TYPE_ALTERNATIVE = "alternative";item.prototype.addProperty = function(name, sourceLineInfo) {
        var retval = new _md.property(name, sourceLineInfo);
        retval.wzParent = this;
        this.properties.push(retval);
        return retval;
...
var property = (function (commentable) {
    ...
    property.TYPE_STRING = "string";property.TYPE_XBOOLEAN = "boolean";property.TYPE_INTEGER = "integer";property.TYPE_XFLOAT = "float";property.TYPE_DATE = "date";property.TYPE_OBJECT = "object";property.TYPE_ANY = "any";property.TYPE_ARRAY = "array";property.TYPE_XFUNCTION = "function";property.TYPE_MERGEDOBJECT = "mergedobject";property.TYPE_ALTERNATIVE = "alternative";property.TYPE_XSWITCH = "switch";property.prototype.addProperty = function(name, sourceLineInfo) {
        var retval = new _md.property(name, sourceLineInfo);
        retval.wzParent = this;
        this.properties.push(retval);
        return retval;
...
var xreturn = (function (commentable) {
    ...
    xreturn.TYPE_ALTERNATIVE = "alternative";xreturn.prototype.addValue = function(name, sourceLineInfo) {
        var retval = new _md.value(name, sourceLineInfo);
        retval.wzParent = this;
        this.values.push(retval);
        return retval;
...
var infoItem = (function (commentable) {
    ...
    infoItem.prototype.toJsonChildren = function(result) {
        ...
        var items, item;
        items = [];
        var i, i_items=this.infoItems, i_len=this.infoItems.length, item;
        for (i=0; i<i_len; i++) {
...
var dependency = (function (infoItem) {
    ...
    dependency.TYPE_CLOSURE = "closure";dependency.prototype.toJson = function() {
        var result = {};
        this.toJsonProperties(result);
        this.toJsonChildren(result);
        return result;
...
var xswitch = (function (commentable) {
    ...
    xswitch.prototype.toJsonChildren = function(result) {
        ...
        var items, item;
        items = [];
        var i, i_items=this.cases, i_len=this.cases.length, item;
        for (i=0; i<i_len; i++) {
            item = this.cases[i];
            items.push(item.toJson());
        }
