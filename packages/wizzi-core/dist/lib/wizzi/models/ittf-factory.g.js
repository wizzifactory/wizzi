/*
    ...
    primary source IttfDocument: C:\My\wizzi\wizzi-mono\packages\wizzi-core\.wizzi\ittf\lib\wizzi\models\ittf-factory.g.js.ittf
*/
'use strict';
...
md.createLoadModel = function(wizziObject) {
    ...
    function loadModelFromMTree(mTree, ittfDocumentUri, wizziModelRequest, options, callback) {
        // log 'wizzi-core.wizzi.models.ittf-factory.g, loaded from mTree'
        ittfmodel(mTree, ittfDocumentUri, wizziModelRequest, callback);
    }
    if (options.loadFromMTree) {
        // Load a WizziModel of type 'ittf' from an mTree
        ...
        /**
             Load a WizziModel of type ittf from an IttfDocument uri
                params
        ...
        */
        return function loadModel(ittfDocumentUri, requestContext, callback) {
                ...
                loadMTree(ittfDocumentUri, requestContext, function(err, mTree) {
                    ...
                    console.log('Loaded mTree instance for pseudo schema ittf from Ittf document ' + ittfDocumentUri + ' in ' + (Date.now() - start) + ' ms');
                    ...
                    // log 'wizzi-core.wizzi.models.ittf-factory.g current __dirname', __dirname
                    // log 'wizzi-core.wizzi.models.ittf-factory.g, loaded from ittfDocumentUri: ', ittfDocumentUri, mTree
                    ittfmodel(mTree, ittfDocumentUri, wizziModelRequest, callback);
                });
            };
    }
...
function error(code, method, message, innerError) {
    ...
    return verify.error(innerError, {
        ...
        method: 'wizzi-core.lib.wizzi.models.ittf-factory.g.' + method,
        parameter: parameter,
