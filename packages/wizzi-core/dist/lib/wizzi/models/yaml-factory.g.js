/*
    ...
    primary source IttfDocument: C:\My\wizzi\wizzi\packages\wizzi-core\.wizzi\ittf\lib\wizzi\models\yaml-factory.g.js.ittf
*/
'use strict';
        ...
        */
        return function loadModel(ittfDocumentUri, requestContext, callback) {
                ...
                loadMTree(ittfDocumentUri, requestContext, function(err, mTree) {
                    ...
                    console.log('Loaded mTree instance for pseudo schema yaml from Ittf document ' + ittfDocumentUri + ' in ' + (Date.now() - start) + ' ms');
