...
var wfschemaBase = (function () {
    ...
    wfschemaBase.prototype.wzSourceErrorLines = function(node, message) {
...
var wfschema = (function (schemaitem) {
    ...
    wfschema.prototype.wzVerify = function(ctx) {
        ...
        var i, i_items=this.exportTos, i_len=this.exportTos.length, item;
        for (i=0; i<i_len; i++) {
        ...
        var i, i_items=this.declares, i_len=this.declares.length, item;
        for (i=0; i<i_len; i++) {
...
var element = (function (schemaitem) {
    ...
    element.TAGTYPE_NUMBER = "number";element.TAGTYPE_CSS_LENGTH = "css-length";element.prototype.addAttribute = function(name, sourceLineInfo) {
    ...
    element.prototype.loadChild = function(child) {
        ...
        if (_l == 14 && _ch == 'h') {
            if (name === 'has-mtree-data') {
                this.hasMTreeData = parseboolean(child.v, true, child); return true;
            }
            else if (name === 'has_mtree_data') {
                this.hasMTreeData = parseboolean(child.v, true, child); return true;
            }
        }
        if (_l == 15 && _ch == 'a') {
    ...
    element.prototype.wzVerify = function(ctx) {
        ...
        var i, i_items=this.restricts, i_len=this.restricts.length, item;
        for (i=0; i<i_len; i++) {
...
var attribute = (function (schemaitem) {
    ...
    attribute.TYPE_STRING = "string";attribute.TYPE_XBOOLEAN = "boolean";attribute.TYPE_INTEGER = "integer";attribute.TYPE_XFLOAT = "float";attribute.TYPE_DATE = "date";attribute.TYPE_REGEXP = "regexp";attribute.TYPE_CODE = "code";attribute.prototype.addRestrict = function(name, sourceLineInfo) {
        var retval = new _md.restrict(name, sourceLineInfo);
        retval.wzParent = this;
        this.restricts.push(retval);
        return retval;
...
var exportTo = (function (schemaitem) {
    ...
    exportTo.NAME_JSON = "json";exportTo.NAME_XML = "xml";exportTo.NAME_PRETTIFY = "prettify";exportTo.prototype.wzVerify = function(ctx) {
...
var xrequire = (function (schemaitem) {
    ...
    xrequire.KIND_XFUNCTION = "function";xrequire.KIND_MODULE = "module";xrequire.KIND_CONTEXT_METHOD = "context-method";xrequire.prototype.loadChild = function(child) {
        // Make test case insensitive
        var item,
            ok = false,
            name = child.n.toLowerCase(),
