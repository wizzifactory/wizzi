/*
    ...
    primary source IttfDocument: C:\My\wizzi\wizzi-mono\packages\wizzi-core\.wizzi\ittf\lib\wizzi\models\json-factory.g.js.ittf
*/
'use strict';
...
md.createLoadModel = function(wizziObject) {
    ...
    function loadModelFromMTree(mTree, ittfDocumentUri, wizziModelRequest, options, callback) {
        // log 'wizzi-core.wizzi.models.json-factory.g, loaded from mTree'
        ...
        */
        return function loadModel(ittfDocumentUri, requestContext, callback) {
                ...
                loadMTree(ittfDocumentUri, requestContext, function(err, mTree) {
                    ...
                    console.log('Loaded mTree instance for pseudo schema json from Ittf document ' + ittfDocumentUri + ' in ' + (Date.now() - start) + ' ms');
...
function error(code, method, message, innerError) {
    ...
    return verify.error(innerError, {
        ...
        method: 'wizzi-core.lib.wizzi.models.json-factory.g.' + method,
        parameter: parameter,
