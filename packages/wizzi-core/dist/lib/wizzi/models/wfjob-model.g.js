...
var wfjob = (function (wfjobBase) {
    ...
    wfjob.prototype.toJsonChildren = function(result) {
        ...
        items = [];
        var i, i_items=this.requires, i_len=this.requires.length, item;
        for (i=0; i<i_len; i++) {
        ...
        items = [];
        var i, i_items=this.models, i_len=this.models.length, item;
        for (i=0; i<i_len; i++) {
            item = this.models[i];
            items.push(item.toJson());
        }
        ...
        result['lines'] = items;
        items = [];
        var i, i_items=this.productions, i_len=this.productions.length, item;
        for (i=0; i<i_len; i++) {
        ...
        items = [];
        var i, i_items=this.execFiles, i_len=this.execFiles.length, item;
        for (i=0; i<i_len; i++) {
...
var model = (function (wfjobBase) {
    ...
    model.prototype.toJsonChildren = function(result) {
        ...
        var items, item;
        items = [];
        var i, i_items=this.modelRefs, i_len=this.modelRefs.length, item;
        for (i=0; i<i_len; i++) {
...
var modelRef = (function (wfjobBase) {
    ...
    modelRef.prototype.toJsonChildren = function(result) {
        ...
        items = [];
        var i, i_items=this.modelCollections, i_len=this.modelCollections.length, item;
        for (i=0; i<i_len; i++) {
...
var modelCollection = (function (wfjobBase) {
    ...
    modelCollection.prototype.toJsonChildren = function(result) {
        ...
        var items, item;
        items = [];
        var i, i_items=this.pathTemplateValues, i_len=this.pathTemplateValues.length, item;
        for (i=0; i<i_len; i++) {
...
var production = (function (wfjobBase) {
    ...
    production.prototype.toJsonChildren = function(result) {
        ...
        result['modelRefs'] = items;
        items = [];
        var i, i_items=this.lineRefs, i_len=this.lineRefs.length, item;
        for (i=0; i<i_len; i++) {
...
var execFile = (function (wfjobBase) {
    ...
    execFile.prototype.toJsonChildren = function(result) {
        ...
        var items, item;
        items = [];
        var i, i_items=this.args, i_len=this.args.length, item;
        for (i=0; i<i_len; i++) {
            item = this.args[i];
            items.push(item.toJson());
        }
        result['args'] = items;
        items = [];
        var i, i_items=this.envs, i_len=this.envs.length, item;
        for (i=0; i<i_len; i++) {
            item = this.envs[i];
            items.push(item.toJson());
        }
