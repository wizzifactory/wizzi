/*
    ...
    primary source IttfDocument: C:\My\wizzi\wizzi-mono\packages\wizzi-helpers\.wizzi\ittf\lib\verify.js.ittf
*/
'use strict';
...
md.getAllRegExp = regexpExt.getAllRegExp;
md.namedRegExp = regexpExt.namedRegExp;
...
md.parseNameValue = function(text, node, options) {
    options = options || {};
...
md.unquote = function(str) {
    ...
    if ((str.substr(0, 1) === "'" && str.substr(-1, 1) === "'" && str.substr(1, str.length -2).indexOf("'") == -1) || (str.substr(0, 1) === "\"" && str.substr(-1, 1) === "\""  && str.substr(1, str.length -2).indexOf("\"") == -1)) {
...
var wzError = (function (Error) {
    ...
    wzError.prototype.toString = function() {
        ...
        if (this.errorLines) {
            ret.push('-> error lines');
            var i, i_items=this.errorLines, i_len=this.errorLines.length, l;
            for (i=0; i<i_len; i++) {
                l = this.errorLines[i];
                ret.push(l);
            }
